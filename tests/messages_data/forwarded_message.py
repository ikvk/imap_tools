...
DATA = dict(
    ...
    from_values=EmailAddress('', 'i.kor@company.ru', 'i.kor@company.ru'),
    to_values=(EmailAddress('Jessica Schmidt', 'jessica.schmidt@uni.de', 'Jessica Schmidt <jessica.schmidt@uni.de>'), EmailAddress('Rabea.Bartölke@uni.de', 'я你Rabea.Bartölke@uni.de', 'Rabea.Bartölke@uni.de <я你Rabea.Bartölke@uni.de>')),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)