...
DATA = dict(
    ...
    to_values=({'email': 'jessica.schmidt@uni.de', 'name': 'Jessica Schmidt', 'full': 'Jessica Schmidt <jessica.schmidt@uni.de>'}, {'email': 'я你Rabea.Bartölke@uni.de', 'name': 'Rabea.Bartölke@uni.de', 'full': 'Rabea.Bartölke@uni.de <я你Rabea.Bartölke@uni.de>'}),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)