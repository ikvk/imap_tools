...
DATA = dict(
    ...
    attachments=[],
    from_values={'email': 'no-reply@crm.el-example.org', 'name': '', 'full': 'no-reply@crm.el-example.org'},
    to_values=({'email': 'e-f5f4@app.ar-example.com', 'name': '', 'full': 'e-f5f4@app.ar-example.com'},),
    cc_values=(),
    bcc_values=(),
    reply_to_values=({'email': '', 'name': 'KLAUS- HÄNSCHEL', 'full': 'KLAUS- HÄNSCHEL'},),
)