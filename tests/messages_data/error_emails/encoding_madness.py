...
DATA = dict(
    ...
    attachments=[],
    from_values=EmailAddress('', 'no-reply@crm.el-example.org', 'no-reply@crm.el-example.org'),
    to_values=(EmailAddress('', 'e-f5f4@app.ar-example.com', 'e-f5f4@app.ar-example.com'),),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(EmailAddress('KLAUS- HÄNSCHEL', '', 'KLAUS- HÄNSCHEL'),),
)