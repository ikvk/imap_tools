...
DATA = dict(
    ...
    attachments=[],
    from_values=EmailAddress('MySurvey.com & Carol Adams', 'carol@mysurvey.com', 'MySurvey.com & Carol Adams <carol@mysurvey.com>'),
    to_values=(EmailAddress('', 'someone@aol.com', 'someone@aol.com'),),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(EmailAddress('', 'carol@reply.mysurvey.com', 'carol@reply.mysurvey.com'),),
)