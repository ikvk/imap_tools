...
DATA = dict(
    ...
    attachments=[],
    from_values={'email': 'j@yahoo-example.com', 'name': '', 'full': 'j@yahoo-example.com'},
    to_values=({'email': 'c@ra-example.com', 'name': '', 'full': 'c@ra-example.com'}, {'email': 'e-r-w-a-4462@app.ar.com', 'name': '', 'full': 'e-r-w-a-4462@app.ar.com'}, {'email': 'leads@ga-example.com', 'name': '', 'full': 'leads@ga-example.com'}),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)