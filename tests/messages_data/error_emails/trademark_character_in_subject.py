...
DATA = dict(
    ...
    attachments=[],
    from_values=EmailAddress('', 'j@yahoo-example.com', 'j@yahoo-example.com'),
    to_values=(EmailAddress('', 'c@ra-example.com', 'c@ra-example.com'), EmailAddress('', 'e-r-w-a-4462@app.ar.com', 'e-r-w-a-4462@app.ar.com'), EmailAddress('', 'leads@ga-example.com', 'leads@ga-example.com')),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)