...
DATA = dict(
    ...
    attachments=[],
    from_values=EmailAddress('Jørn Støylen', 'jorn@prikkprikkprikk.no', 'Jørn Støylen <jorn@prikkprikkprikk.no>'),
    to_values=(EmailAddress('AF Test', 'aftest@adfontesmedier.no', 'AF Test <aftest@adfontesmedier.no>'),),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)