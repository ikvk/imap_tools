...
DATA = dict(
    ...
    attachments=[],
    from_values={'email': 'jorn@prikkprikkprikk.no', 'name': 'Jørn Støylen', 'full': 'Jørn Støylen <jorn@prikkprikkprikk.no>'},
    to_values=({'email': 'aftest@adfontesmedier.no', 'name': 'AF Test', 'full': 'AF Test <aftest@adfontesmedier.no>'},),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)