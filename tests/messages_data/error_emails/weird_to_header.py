...
DATA = dict(
    ...
    attachments=[],
    from_values={'email': 'anonymous@i.tp.host', 'name': '', 'full': 'anonymous@i.tp.host'},
    to_values=({'email': 'user-example@aol.com', 'name': '', 'full': 'user-example@aol.com'}, {'email': 'e-s-a-s-2200@app.ar.com', 'name': '', 'full': 'e-s-a-s-2200@app.ar.com'}),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)