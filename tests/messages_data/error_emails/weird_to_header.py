...
DATA = dict(
    ...
    attachments=[],
    from_values=EmailAddress('', 'anonymous@i.tp.host', 'anonymous@i.tp.host'),
    to_values=(EmailAddress('', 'user-example@aol.com', 'user-example@aol.com'), EmailAddress('', 'e-s-a-s-2200@app.ar.com', 'e-s-a-s-2200@app.ar.com')),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)