...
DATA = dict(
    ...
    bcc=(),
    reply_to=('ak@g.com',),
    date=datetime.datetime(2009, 9, 19, 19, 49, 36, tzinfo=datetime.timezone(datetime.timedelta(0, 14400))),
    ...
    attachments=[],
    from_values={'email': 'ak@g.com', 'name': 'Andrey Kuznetsov', 'full': 'Andrey Kuznetsov <ak@g.com>'},
    to_values=({'email': 'abuser@r.ru', 'name': '', 'full': 'abuser@r.ru'},),
    cc_values=(),
    bcc_values=(),
    reply_to_values=({'email': 'ak@g.com', 'name': '', 'full': 'ak@g.com'},),
)