...
DATA = dict(
    ...
    attachments=[],
    from_values=EmailAddress('Andrey Kuznetsov', 'ak@g.com', 'Andrey Kuznetsov <ak@g.com>'),
    to_values=(EmailAddress('', 'abuser@r.ru', 'abuser@r.ru'),),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(EmailAddress('', 'ak@g.com', 'ak@g.com'),),
)