...
DATA = dict(
    ...
    attachments=[],
    from_values=EmailAddress('Wilmer Capps', 'fyouizjnp@swissonline.ch', 'Wilmer Capps <fyouizjnp@swissonline.ch>'),
    to_values=(EmailAddress('', 'bait-passover@em.ca', 'bait-passover@em.ca'),),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)