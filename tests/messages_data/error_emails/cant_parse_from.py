...
DATA = dict(
    ...
    attachments=[],
    from_values={'email': 'News@InsideApple.Apple.com', 'name': 'Apple', 'full': 'Apple <News@InsideApple.Apple.com>'},
    to_values=({'email': 'karl.baum@gmail.com', 'name': '', 'full': 'karl.baum@gmail.com'},),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)