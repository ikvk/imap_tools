...
DATA = dict(
    ...
    attachments=[],
    from_values=EmailAddress('', 'l@gcn-example.com', 'l@gcn-example.com'),
    to_values=(EmailAddress('', 'leads@sg.dc.com', 'leads@sg.dc.com'), EmailAddress('', 'sag@leads.gs.ry.com', 'sag@leads.gs.ry.com'), EmailAddress('', 'sn@example-hotmail.com', 'sn@example-hotmail.com'), EmailAddress('', 'e-s-a-g-8718@app.ar.com', 'e-s-a-g-8718@app.ar.com'), EmailAddress('', 'jp@t-exmaple.com', 'jp@t-exmaple.com'), EmailAddress('', 'cc@c-l-example.com', 'cc@c-l-example.com')),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)