...
DATA = dict(
    ...
    attachments=[],
    from_values={'email': 'l@gcn-example.com', 'name': '', 'full': 'l@gcn-example.com'},
    to_values=({'email': 'leads@sg.dc.com', 'name': '', 'full': 'leads@sg.dc.com'}, {'email': 'sag@leads.gs.ry.com', 'name': '', 'full': 'sag@leads.gs.ry.com'}, {'email': 'sn@example-hotmail.com', 'name': '', 'full': 'sn@example-hotmail.com'}, {'email': 'e-s-a-g-8718@app.ar.com', 'name': '', 'full': 'e-s-a-g-8718@app.ar.com'}, {'email': 'jp@t-exmaple.com', 'name': '', 'full': 'jp@t-exmaple.com'}, {'email': 'cc@c-l-example.com', 'name': '', 'full': 'cc@c-l-example.com'}),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)