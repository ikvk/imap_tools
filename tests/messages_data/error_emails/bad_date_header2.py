...
DATA = dict(
    ...
    attachments=[],
    from_values={'email': 'enews@Free-Quilting.com', 'name': 'Free-Quilting.com', 'full': 'Free-Quilting.com <enews@Free-Quilting.com>'},
    to_values=({'email': 'someone@live.com', 'name': '', 'full': 'someone@live.com'},),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)