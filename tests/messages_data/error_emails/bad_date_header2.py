...
DATA = dict(
    ...
    attachments=[],
    from_values=EmailAddress('Free-Quilting.com', 'enews@Free-Quilting.com', 'Free-Quilting.com <enews@Free-Quilting.com>'),
    to_values=(EmailAddress('', 'someone@live.com', 'someone@live.com'),),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)