...
DATA = dict(
    ...
    attachments=[],
    from_values=EmailAddress(name='neal ragland', email='shechem@poetrix.com'),
    to_values=(EmailAddress(name='palmer vladi.Pimenovraud', email='vladi.Pimenov@enron.com'),),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)