...
DATA = dict(
    ...
    attachments=[],
    from_values=EmailAddress('chianfong cuthbert', 'abhijit.862153drinnan@datavalet.com', 'chianfong cuthbert <abhijit.862153drinnan@datavalet.com>'),
    to_values=(EmailAddress('', 'cvs@bruce-guenter.dyndns.org', 'cvs@bruce-guenter.dyndns.org'),),
    cc_values=(EmailAddress('', 'rait@bruce-guenter.dyndns.org', 'rait@bruce-guenter.dyndns.org'),),
    bcc_values=(),
    reply_to_values=(EmailAddress('chianfong cuthbert', 'abhijit.862153drinnan@datavalet.com', 'chianfong cuthbert <abhijit.862153drinnan@datavalet.com>'),),
)