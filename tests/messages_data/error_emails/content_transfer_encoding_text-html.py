...
DATA = dict(
    ...
    attachments=[],
    from_values={'email': 'abhijit.862153drinnan@datavalet.com', 'name': 'chianfong cuthbert', 'full': 'chianfong cuthbert <abhijit.862153drinnan@datavalet.com>'},
    to_values=({'email': 'cvs@bruce-guenter.dyndns.org', 'name': '', 'full': 'cvs@bruce-guenter.dyndns.org'},),
    cc_values=({'email': 'rait@bruce-guenter.dyndns.org', 'name': '', 'full': 'rait@bruce-guenter.dyndns.org'},),
    bcc_values=(),
    reply_to_values=({'email': 'abhijit.862153drinnan@datavalet.com', 'name': 'chianfong cuthbert', 'full': 'chianfong cuthbert <abhijit.862153drinnan@datavalet.com>'},),
)