...
DATA = dict(
    ...
    bcc=(),
    reply_to=(),
    date=datetime.datetime(2009, 12, 2, 22, 39, 33, tzinfo=datetime.timezone(datetime.timedelta(0, 46800))),
    ...
    attachments=[],
    from_values={'email': 'tester1@test.com', 'name': 'Tester 1', 'full': 'Tester 1 <tester1@test.com>'},
    to_values=({'email': 'tester2@test.com', 'name': '', 'full': 'tester2@test.com'},),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)