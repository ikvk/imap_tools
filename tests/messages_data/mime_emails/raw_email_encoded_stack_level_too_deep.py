...
DATA = dict(
    ...
    attachments=[],
    from_values={'email': 'gmail-noreply@google.com', 'name': 'Gmail Team', 'full': 'Gmail Team <gmail-noreply@google.com>'},
    to_values=({'email': 'a.b@gmail.com', 'name': 'Nicolas Fouché', 'full': 'Nicolas Fouché <a.b@gmail.com>'},),
    cc_values=(),
    bcc_values=(),
    reply_to_values=({'email': 'x.y@gmail.com', 'name': '', 'full': 'x.y@gmail.com'},),
)