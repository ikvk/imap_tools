...
DATA = dict(
    ...
    bcc=(),
    reply_to=(),
    date=datetime.datetime(2006, 10, 20, 4, 28, 33, tzinfo=datetime.timezone(datetime.timedelta(-1, 72000))),
    ...
    from_values={'email': 'MAILER-DAEMON@antivirus.uqam.ca', 'name': 'Mail Delivery Subsystem', 'full': 'Mail Delivery Subsystem <MAILER-DAEMON@antivirus.uqam.ca>'},
    to_values=({'email': 'roor32@gmail.com', 'name': '', 'full': 'roor32@gmail.com'},),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)