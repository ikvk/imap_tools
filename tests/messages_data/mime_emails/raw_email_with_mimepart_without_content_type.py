...
DATA = dict(
    ...
    from_values=EmailAddress('Mail Delivery Subsystem', 'MAILER-DAEMON@antivirus.uqam.ca', 'Mail Delivery Subsystem <MAILER-DAEMON@antivirus.uqam.ca>'),
    to_values=(EmailAddress('', 'roor32@gmail.com', 'roor32@gmail.com'),),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)