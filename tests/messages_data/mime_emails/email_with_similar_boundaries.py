...
DATA = dict(
    ...
    from_values={'email': 'xxxxxx@xxxxxxxx.xxx', 'name': 'Xxxxx', 'full': 'Xxxxx <xxxxxx@xxxxxxxx.xxx>'},
    to_values=({'email': 'xxxxxxx@xxxxxxxxxxx.xxx', 'name': '', 'full': 'xxxxxxx@xxxxxxxxxxx.xxx'},),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)