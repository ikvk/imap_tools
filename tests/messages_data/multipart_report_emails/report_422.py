...
DATA = dict(
    ...
    attachments=[],
    from_values={'email': 'MAILER-DAEMON@tppppp.com.au', 'name': 'Mail Delivery Subsystem', 'full': 'Mail Delivery Subsystem <MAILER-DAEMON@tppppp.com.au>'},
    to_values=({'email': 'jennifer@sss.sssssss.net.au', 'name': '', 'full': 'jennifer@sss.sssssss.net.au'},),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)