...
DATA = dict(
    ...
    from_values=EmailAddress('Mail Delivery System', 'MAILER-DAEMON@lvmail01.LL.com', 'Mail Delivery System <MAILER-DAEMON@lvmail01.LL.com>'),
    to_values=(EmailAddress('', 'rahul.chaudhari@LL.com', 'rahul.chaudhari@LL.com'),),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)