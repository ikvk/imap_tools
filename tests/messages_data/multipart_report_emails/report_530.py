...
DATA = dict(
    ...
    attachments=[],
    from_values={'email': 'MAILER-DAEMON@tttttt.com.au', 'name': 'Mail Delivery Subsystem', 'full': 'Mail Delivery Subsystem <MAILER-DAEMON@tttttt.com.au>'},
    to_values=({'email': 'mikel@sssss.net', 'name': '', 'full': 'mikel@sssss.net'},),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)