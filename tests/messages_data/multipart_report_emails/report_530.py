...
DATA = dict(
    ...
    attachments=[],
    from_values=EmailAddress('Mail Delivery Subsystem', 'MAILER-DAEMON@tttttt.com.au', 'Mail Delivery Subsystem <MAILER-DAEMON@tttttt.com.au>'),
    to_values=(EmailAddress('', 'mikel@sssss.net', 'mikel@sssss.net'),),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)