...
DATA = dict(
    ...
    attachments=[],
    from_values=EmailAddress('Mikel Lindsaar', 'test@lindsaar.net', 'Mikel Lindsaar <test@lindsaar.net>'),
    to_values=(EmailAddress('Mikel Lindsaar', 'raasdnil@gmail.com', 'Mikel Lindsaar <raasdnil@gmail.com>'),),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)