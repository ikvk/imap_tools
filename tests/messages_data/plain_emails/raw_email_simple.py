...
DATA = dict(
    ...
    attachments=[],
    from_values={'email': 'mikel@nowhere.com', 'name': 'Mikel Lindsaar', 'full': 'Mikel Lindsaar <mikel@nowhere.com>'},
    to_values=({'email': 'mikel@somewhere.com', 'name': 'Mikel', 'full': 'Mikel <mikel@somewhere.com>'},),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)