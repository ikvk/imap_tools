...
DATA = dict(
    ...
    bcc=(),
    reply_to=(),
    date=datetime.datetime(2007, 11, 18, 19, 56, 7, tzinfo=datetime.timezone(datetime.timedelta(0, 39600))),
    ...
    attachments=[],
    from_values={'email': 'xxxxxxxx@xxx.org', 'name': 'Testing', 'full': 'Testing <xxxxxxxx@xxx.org>'},
    to_values=({'email': 'mikel@xxxx.net', 'name': 'Mikel Lindsaar', 'full': 'Mikel Lindsaar <mikel@xxxx.net>'},),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)