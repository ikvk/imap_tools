...
DATA = dict(
    ...
    attachments=[],
    from_values=EmailAddress('Testing', 'xxxxxxxx@xxx.org', 'Testing <xxxxxxxx@xxx.org>'),
    to_values=(EmailAddress('Mikel Lindsaar', 'mikel@xxxx.net', 'Mikel Lindsaar <mikel@xxxx.net>'),),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)