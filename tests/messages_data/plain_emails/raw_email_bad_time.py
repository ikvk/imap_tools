...
DATA = dict(
    ...
    attachments=[],
    from_values={'email': 'yusuf75thu@auracom.net', 'name': 'Атиковa', 'full': 'Атиковa <yusuf75thu@auracom.net>'},
    to_values=({'email': 'abcdefg@AAAAAAAAA.net', 'name': '', 'full': 'abcdefg@AAAAAAAAA.net'},),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)