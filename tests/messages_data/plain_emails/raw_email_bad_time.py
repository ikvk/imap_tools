...
DATA = dict(
    ...
    attachments=[],
    from_values=EmailAddress('Атиковa', 'yusuf75thu@auracom.net', 'Атиковa <yusuf75thu@auracom.net>'),
    to_values=(EmailAddress('', 'abcdefg@AAAAAAAAA.net', 'abcdefg@AAAAAAAAA.net'),),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)