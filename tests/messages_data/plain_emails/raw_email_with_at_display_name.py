...
DATA = dict(
    ...
    to_values=(EmailAddress('', 'smith@gmail.com', 'smith@gmail.com'), EmailAddress('', 'Mikel@Lindsaar', 'Mikel@Lindsaar'), EmailAddress('', 'raasdnil@gmail.com', 'raasdnil@gmail.com'), EmailAddress('', 'tom@gmail.com', 'tom@gmail.com')),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)