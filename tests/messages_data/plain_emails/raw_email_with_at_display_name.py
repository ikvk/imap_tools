...
DATA = dict(
    ...
    to_values=({'email': 'smith@gmail.com', 'name': '', 'full': 'smith@gmail.com'}, {'email': 'Mikel@Lindsaar', 'name': '', 'full': 'Mikel@Lindsaar'}, {'email': 'raasdnil@gmail.com', 'name': '', 'full': 'raasdnil@gmail.com'}, {'email': 'tom@gmail.com', 'name': '', 'full': 'tom@gmail.com'}),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)