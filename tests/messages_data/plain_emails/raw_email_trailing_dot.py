...
DATA = dict(
    ...
    bcc=(),
    reply_to=(),
    date=datetime.datetime(2008, 9, 22, 15, 6, 28, tzinfo=datetime.timezone(datetime.timedelta(-1, 72000))),
    ...
    attachments=[],
    from_values={'email': 'noreply@rubyforge.org', 'name': 'Sandy M.', 'full': 'Sandy M. <noreply@rubyforge.org>'},
    to_values=({'email': 'noreply@rubyforge.org', 'name': '', 'full': 'noreply@rubyforge.org'},),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)