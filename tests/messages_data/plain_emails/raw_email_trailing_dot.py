...
DATA = dict(
    ...
    attachments=[],
    from_values=EmailAddress('Sandy M.', 'noreply@rubyforge.org', 'Sandy M. <noreply@rubyforge.org>'),
    to_values=(EmailAddress('', 'noreply@rubyforge.org', 'noreply@rubyforge.org'),),
    cc_values=(),
    bcc_values=(),
    reply_to_values=(),
)