...
YjNmYmE0MGNjZDk2MDMwODRiZS0tDQo=""".replace('\n', '\r\n'),
    ...
    'text_with_content_id': dict(
        ...
        from_values={'email': 'ne-pas-repondre@email-test.fr', 'name': 'email-test.fr',
                     'full': 'email-test.fr <ne-pas-repondre@email-test.fr>'},
        to_values=({'email': 'service.courrier@mairie-email-test.fr', 'name': 'Courrier',
                    'full': 'Courrier <service.courrier@mairie-email-test.fr>'},),
        cc_values=(),
        bcc_values=(),
        reply_to_values=(
            {'email': 'emmanuellehelou@orange.fr', 'name': 'HELOU', 'full': 'HELOU <emmanuellehelou@orange.fr>'},),
    ),
    'address_quoted_newlines': dict(
        subject='Daily',
        from_='status@sender.com',
        ...
        reply_to=(),
        date=datetime.datetime(2020, 11, 1, 14, 49, 7,
        ...
        headers={'message-id': ('<5fa9c763>',), 'date': ('Mon, 01 Nov 2020 14:49:07 -0800 (PST)',),
                 'mime-version': ('1.0',), 'from': ('"Sender" <status@sender.com>',),
                 'to': ('My Name <my.name@domain.com>, Other Name\r\n    <other.name@domain.com>',), 'cc': (
                'Third Name <third.name@domain.com>, "Quoted Mailing List\r\n One" <quoted-mailing-list-one@domain.com>, "Quoted\r\n Mailing List Two" <quoted-mailing-list-two@domain.com>',),
                 'bcc': (
                     'My Name <my.name@domain.com>, Mailing List One - One Name\r\n    <list1-one-name@domain.com>, Mailing List Two - Second Name\r\n    <list2-second-name@domain.com>',),
                 'subject': ('Daily',),
                 'content-type': ('multipart/mixed; boundary=--boundary_20_d4727d16-8454-4fa4-9da0-950a95b2c962',)},
        attachments=[
            dict(
        ...
        from_values={'email': 'status@sender.com', 'name': 'Sender', 'full': 'Sender <status@sender.com>'},
        to_values=({'email': 'my.name@domain.com', 'name': 'My Name', 'full': 'My Name <my.name@domain.com>'},
                   {'email': 'other.name@domain.com', 'name': 'Other Name',
                    'full': 'Other Name <other.name@domain.com>'}),
        cc_values=(
            {'email': 'third.name@domain.com', 'name': 'Third Name', 'full': 'Third Name <third.name@domain.com>'},
            {'email': 'quoted-mailing-list-one@domain.com', 'name': 'Quoted Mailing List One',
             'full': 'Quoted Mailing List One <quoted-mailing-list-one@domain.com>'},
            {'email': 'quoted-mailing-list-two@domain.com', 'name': 'Quoted Mailing List Two',
             'full': 'Quoted Mailing List Two <quoted-mailing-list-two@domain.com>'}),
        bcc_values=({'email': 'my.name@domain.com', 'name': 'My Name', 'full': 'My Name <my.name@domain.com>'},
                    {'email': 'list1-one-name@domain.com', 'name': 'Mailing List One - One Name',
                     'full': 'Mailing List One - One Name <list1-one-name@domain.com>'},
                    {'email': 'list2-second-name@domain.com', 'name': 'Mailing List Two - Second Name',
                     'full': 'Mailing List Two - Second Name <list2-second-name@domain.com>'}),
        reply_to_values=(),
    ),
    'forwarded_message': dict(
        ...
        'Jessica Schmidt <jessica.schmidt@uni.de>,\r\n\t=?iso-8859-1?Q?Rabea=2EBart=F6lke=40uni=2Ede?= <\udcd1\udc8f\udce4\udcbd\udca0Rabea.Bart\udcc3\udcb6lke@uni.de>',),
                 'from': ('i.kor@company.ru',), 'message-id': ('<2405271c-86ac-0a65-e50c-d1ebccfcc644@company.ru>',),
                 'date': ('Thu, 12 Oct 2017 09:41:56 +0500',), 'mime-version': ('1.0',),
                 'in-reply-to': ('<20171011085432.15374.20485@web.hades.company>',),
                 'content-type': ('multipart/mixed;\r\n boundary="------------BF90926EC9DF73443A6B8F28"',),
                 'content-language': ('ru',)},
        attachments=[
            dict(
